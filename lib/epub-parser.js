		        ...
		        //  console.log('epub version:'+epubVersion);
			      ...
			      if(!ncxId) { // assume epub 3 navigation doc
			          ...
			          parser.parseString(ncxDataXML.toString(), function (err, ncxJSON) {
		        			...
		        			ncx = (ncxJSON[ncxPrefix+"ncx"]!= undefined)?ncxJSON[ncxPrefix+"ncx"]:ncxJSON["ncx"];

							var navPoints = (ncx[ncxPrefix+"navMap"] != undefined)? ncx[ncxPrefix+"navMap"][0][ncxPrefix+"navPoint"]:ncx["navMap"][0]["navPoint"];
